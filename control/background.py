...
while True:
    ...
    if active_post is None:
        ...
        try:
            ...
            print(colorama.Fore.WHITE + colorama.Back.RED + "Exception occurred during analysis: {}\n"
                                                            "Setting {} to FAILED.".format(str(e), active_post["_id"])
                                                            + colorama.Style.RESET_ALL)
            db.mongo.modify(active_post["_id"], {"$set": {"status": "Failed"}})
